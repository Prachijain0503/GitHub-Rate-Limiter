...
public class GitUserController {
    ...
    public com.github.ratelimiter.model.GitUser user (@PathVariable String name,@PathVariable String lastName,@PathVariable String location) throws Exception {
        return gitUserService.get(name, lastName, location);
    }

    @RequestMapping(value = "/user", method = RequestMethod.POST)
    public List<GitUser> findUser(@RequestBody List<UserProfileRequest> profiles) throws Exception {
